...
title: "TyPkg"
date: "2025/10/22"
description: "A CLI tool to install Typst packages from GitHub as **local packages**."
repoURL: "https://github.com/rice8y/typkg"
---
...
This project is distributed under the MIT License. See [LICENSE](https://raw.githubusercontent.com/rice8y/typkg/main/LICENSE).