...
repoURL: "https://github.com/rice8y/typixel"
customLinks:
  - label: "Typst Universe"
    url: "https://typst.app/universe/package/typixel"
---

![Typixel Logo](/images/projects/typixel/logo.png)
...
![Comparison: Original image vs Pixel art version](/images/projects/typixel/ex01.png)
...
![Red trapezoidal pixel art generated from text map](/images/projects/typixel/ex02.png)
...
![Rainbow gradient example using circle shapes](/images/projects/typixel/ex03.png)
...
![Mixed shapes example showing stars, circles, diamonds, and hearts](/images/projects/typixel/ex04.png)
...
![Custom octagon shape example](/images/projects/typixel/ex05.png)
...
The example image `gahag.jpg` is based on an image from [GAHAG](https://raw.githubusercontent.com/rice8y/typixel/main/LICENSE) and is licensed under CC0.